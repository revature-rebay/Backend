...
public class CartServiceTest {
    ...
    public void setUp(){
        ...
        user.setRoleId(1);
        Product product1 = new Product(1, 50.00, 0, true,100, "".getBytes(), "Product Name here", "Product Description here");
        Product product2 = new Product(2, 150.00, 0, true,100, "".getBytes(), "Product Name here", "Product Description here");
